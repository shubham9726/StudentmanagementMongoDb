package student1mvc.config

import student1mvc.common.constant.SpringProfile
...
@PropertySource('file:${SPRING_BOOT_PROPERTIES_DIR}/student1mvc.properties')
class SecondaryDataSourceLocalConfig extends SecondaryDataSourceAbstractConfig {
    ...
    SecondaryDataSourceLocalConfig() {
        ...
        assert Files.exists(Paths.get("${dir}/student1mvc.properties")),
                "${dir}/student1mvc.properties containing externalized datasource properties must exist"
    }
